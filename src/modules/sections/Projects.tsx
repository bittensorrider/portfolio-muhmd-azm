        ...
        <div>
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-subtle bg-(--bg)/60 backdrop-blur px-3 py-2 text-sm focus-ring"
                  type="search"
                  autoComplete="off"
                />
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="rounded-xl border border-subtle bg-(--bg)/60 backdrop-blur px-3 py-2 text-sm focus-ring"
                >
              ...
              <div className="inline-flex rounded-xl border border-subtle bg-(--bg)/60 backdrop-blur p-0.5">
                <button
                  type="button"
                  aria-pressed={view === "grid"}
                  onClick={() => setView("grid")}
                  className={`h-9 w-9 rounded-lg focus-ring transition cursor-pointer  ${view === "grid" ? "bg-(--bg)/70" : "hover:bg-(--bg)/90"}`}
                  title="Grid view"
                >
                  <svg
                    viewBox="0 0 24 24"
                    className="mx-auto h-5 w-5 text-(--text)"
                    fill="currentColor"
                    aria-hidden="true"
                  >
                ...
                <button
                  ...
                  className={`h-9 w-9 rounded-lg focus-ring transition cursor-pointer ${view === "list" ? "bg-(--bg)/70" : "hover:bg-(--bg)/90"}`}
                  title="List view"
                >
                  <svg
                    viewBox="0 0 24 24"
          ...
          {filtered &&
            ...
            (view === "grid" ? (
              ...
              <ul className="mt-4 divide-y divide-(--border) rounded-xl border border-subtle bg-surface">
                {filtered.map((r) => (
                    ...
                    >
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {r.language && (
                            <span className="rounded-md border border-subtle bg-(--bg) px-2 py-0.5 text-xs">
                              {r.language}
                            </span>
                          )}
                        </div>
